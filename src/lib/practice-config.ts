...
export const practiceTemplates: Record<string, PracticeConfig> = {
  'ddrheinrich': {
    id: 'ddrheinrich',
    name: 'Ddrheinrich Clinic',
    doctor: 'Ddrheinrich Clinic Team',
...
export function getCurrentPractice(): PracticeConfig {
  ...
  return practiceTemplates['ddrheinrich'];
}